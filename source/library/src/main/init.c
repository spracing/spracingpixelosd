...
{
#ifdef STM32H7
    if ((SPRACING_PIXEL_OSD_SYNC_OUT_Pin == GPIO_PIN_8) && (SPRACING_PIXEL_OSD_SYNC_OUT_GPIO_Port == GPIOA)) {
...
{
    // TODO ensure DMA ram is configured, e.g.
